// js/descricaoProdutoAuto.js
import { jsPDF } from 'jspdf';

export function initDescriptionAutoPage() {
    ...
    // GUARDA DE SEGURANÇA: Se o formulário não existir na página atual, ignora o script
    if (!formDescriptionAuto) return;
    ...
    if (btnPrint) {
        btnPrint.addEventListener("click", () => {
            ...
            if (!iframe) {
                console.error("Iframe de impressão não encontrado no DOM.");
                return;
            }

            // Recarrega a fonte do iframe
